sap.ui.define([
	"sap/ui/test/Opa5",
	"fiori/demo/app/FIORI-DEMO/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function(Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("fiori.demo.app.FIORI-DEMO.test.integration.arrangements.Startup", {
		...
		iStartMyApp : function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "fiori.demo.app.FIORI-DEMO",
					async: true
				},
				hash: oOptions.hash,
